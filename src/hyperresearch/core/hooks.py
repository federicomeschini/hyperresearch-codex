"""Shared hyperresearch agent prompt templates.

The Codex bundle renders these prompt constants into `.codex/agents/*.toml`
files and translates provider-specific wording at install time.
"""
